...
export function PaymentForm(){
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        const result = await stripe.confirmPayment({
            ...
            elements,
            confirmParams: {
                return_url: `${window.location.origin}/login`, //TODO: redirect to another page that check payment status and change user roles to adherent if all good. Allow user to download invoice
            },
        });
    };
    return (
